...
namespace Ensamblador_SIC
{
    public partial class Form1 : Form
    {
        ...
        private string codigoObjeto()
        {
            ...
            //int iDireccionInicio = (int)this.ensamblador.programa[0].sDireccion.Substring(0, this.ensamblador.programa[0].sDireccion.Length - 1);
            ...
            if (i < 6)
            {
                ...
                {
                    //sRegistroEncabezado = sRegistroEncabezado + " ";
                    sEspacio = sEspacio + '_';
                }
            ...
            sRegistroTexto = sRegistroTexto + this.ensamblador.programa[2].sDireccionHEXA + "XX";
            iDireccionInicio = Convert.ToInt32(this.ensamblador.programa[2].sDireccionHEXA, 16);
            ...
            foreach (var l in this.ensamblador.programa)
            {
                    ...
                    l.sCodigoOp != "RESW" && l.sCodigoOp != "RESB")
                {
                    if (sRegistroTexto.Length <= 69)
                    {
                        ...
                        //int iTotalLetras = l.sCodigoObjeto.Length;
                        foreach (var c in l.sCodigoObjeto)
                        {
                            ...
                            else
                            {
                                ...
                                sRegistroTexto = "T" + l.sDireccionHEXA + "XX";
                            }
                        }
                    }
                    else
        ...
        private void mapaMemoria()
        {
            ...
            //this.dataGridView4.Columns[0].Width = 50;

            Dictionary<string,List<string>> mapaMemoria = new Dictionary<string, List<string>>();
            int inicioProgrma = Convert.ToInt32(this.sTamaInicial, 16);
            int finalProgrma = Convert.ToInt32(this.sTamaFinal, 16);

            //int inicio = this.RoundDown(inicioProgrma);
            ...
            {
                direccion = $"{i:X}";
                this.dataGridView4.Rows.Add(direccion, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
            }
        }
